...
"padding-left: 3px")
        ...
        icon = QIcon()
        icon.addFile(u"images/login.png", QSize(), QIcon.Normal, QIcon.Off)
...
"background-image: url(\"images/parkeapp.png\");\n"
"border: 0px;\n"
"}")
...
"")
        ...
        icon1 = QIcon()
        icon1.addFile(u"images/carwhite.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u"images/Logo_U.T.P..png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"images/textAbout.fw.png", QSize(), QIcon.Normal, QIcon.Off)
