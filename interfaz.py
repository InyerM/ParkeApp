...
from PySide2.QtGui import (QBrush, QColor, QCursor, QFont, QFontDatabase, QIcon, QKeySequence, QLinearGradient, QPalette, QPainter, QPixmap, QRadialGradient)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon(u"icono.ico"))
